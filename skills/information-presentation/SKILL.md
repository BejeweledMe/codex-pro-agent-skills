...
When the presentation needs a persuasive or decision-oriented arc, use:

`situation -> tension -> resolution -> proof -> action`

Adapt the arc instead of forcing it. A research presentation may use question, method, findings, interpretation, and implications; a decision deck may use context, problem, evidence, options, recommendation, impact, risks, and action.
