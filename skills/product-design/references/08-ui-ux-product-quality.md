...
Если причина сбоя flow неясна, проверить связанные точки опыта: обещание в рекламе или письме, действия sales/support, необходимые офлайн-услуги и условия возвращения в продукт. У нового и давнего пользователя могут отличаться ожидания и контекст. Ошибка первого использования может начинаться с обещания в onboarding-письме. Расширять диагностику только на связи, существенные для запроса; наблюдение за соседним каналом само по себе не поручает его переделку. Этот взгляд на сквозной опыт дополняет UX guidance синтезом по «Вдохновленным» Марти Кагана; см. [индекс](00-index.md).
